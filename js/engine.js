...
export class Engine {
 ...
 startDispatch({incidentId,vehicleId,prisonId}){
  ...
  const capacityEvents=[];if(sessionConfig.operationMode==="autoplay"&&incident.capacityExceeded&&!incident.capacityWarningLogged){incident.capacityWarningLogged=true;capacityEvents.push({type:"capacityWarning",incident,message:"[WAARSCHUWING] Totale cellencapaciteit bereikt. Reistijd verdubbeld."});}
